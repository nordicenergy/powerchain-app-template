    ...
    render(){
       let data = [

        {
            ...
            desc: 'There are many variations of passages of Lorem Ipsum available,but the majorityhave suffered alteration - Blockchan based Energy Trading Client App'
        },
                   ...
                   <div className="row">
                       <div className="col-lg-12">
                            <div className="section-title text-center mb--40">
                                ...
                                <p>There are many variations of passages of Lorem Ipsum available, but the majorityhave suffered alteration - Blockchan based Energy Trading Client App</p>
                            </div>
                       </div>
                   </div>
