                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="section-title text-center mb--40">
                                    ...
                                    <p className="text-white">Energy Exchange Platform - Blockchan based Energy Trading Client App</p>
                                </div>
                            </div>
                        </div>
                        <div className="row">
                                ...
                                <div className="contact-inner">
                                    ...
                                    <div className="conatct-info">
                                        ...
                                        <div className="single-contact-info">
                                            ...
                                            <div className="contact-text">
                                                <span>mailto:powerchain@nordicenergy.io<br/>
                            ...
                            <div className="col-lg-8 offset-lg-2 col-xl-6 offset-xl-3">
                                <div className="newsletter text-center">
                                    ...
                                    <p className="text-white">There are many variations of passages of Lorem Ipsum available,<br />
                                        but the majorityhave alteration - Blockchan based Energy Trading Client App</p>
