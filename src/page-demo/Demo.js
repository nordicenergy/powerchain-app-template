...
class Demo extends Component{
    render(){
        ...
        let demos = [
            ...
            {demoImg: 'blog-details.png', demoLink: 'blog-details', demoTitle: 'Blog'},
        ];
        ...
        let features = [
            ...
            {featureIconName: 'icon-profile-male', featureTitle: 'Energy Storage', featureDescription: 'Castro easy to use for any technical & nontechnical People.'},
                    ...
                    <div className="header-section section sticker">
                        ...
                        <div className="row justify-content-between align-items-center">
                            ...
                            <div className="col-6 text-right">
                                <a className="buy-btn" href="/">Buy Tokens</a>
                            </div>
                        </div>
                        </div>
                    </div>
                    ...
                    <div className="hero-section section overlay landing-hero-bg">
                        ...
                        <div className="row">
                            <div className="hero-content text-center col-12">
                                <h1><strong>Tokens</strong>React Multipurpose Landing Page Template</h1>
                        ...
                        <div className="container">
                            <div className="row">
                                <div className="col-12">
                                    ...
                                    <a className="buy-btn float-right" href="//nordicenergy.app">Buy Tokens</a>
                                </div>
                            </div>
                        </div>
                    </div>
